  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        catGhost:
          "hover:bg-orange-400 hover:text-white dark:hover:bg-slate-800 dark:hover:text-slate-50 ease-in-out duration-400",
        catGhostEdit:
          "bg-orange-500 hover:bg-orange-800 text-white dark:hover:bg-slate-800 dark:hover:text-slate-50 ease-in-out duration-400",
      },
      size: {
